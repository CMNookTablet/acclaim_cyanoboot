...
#define MUX_FIELD(x) (OMAP44XX_CTRL_BASE+(x))
...
#define CONTROL_CORE_PAD0_KPD_COL5_PAD1_KPD_COL0	0x0180
...
#define CONTROL_CORE_PAD0_KPD_ROW5_PAD1_KPD_ROW0	0x018C
#define CONTROL_PADCONF_UNIPRO_RY1		0x018E
#define CONTROL_CORE_PAD0_KPD_ROW1_PAD1_KPD_ROW2	0x0190
